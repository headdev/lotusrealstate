...
export interface SectionHero2ArchivePageRealstateProps {
  className?: string;
  children?: React.ReactNode;
}

const SectionHero2ArchivePageRealstate: FC<SectionHero2ArchivePageRealstateProps> = ({
  className = "",
  children,
}) => {
  return (
    <div
      className={`nc-SectionHero2ArchivePageRealstate relative ${className}`}
      data-nc-id="SectionHero2ArchivePageRealstate"
    >
...
export default SectionHero2ArchivePageRealstate;
