...
const defaultPropertyType: ClassOfProperties[] = [
  {
    name: "Cabaña",
    description: "🏡 Disfruta de un espacio privado solo para ti",
    checked: true,
  },
  {
    name: "Apartamento",
    description: "🏢 Ten tu propia habitación y comparte algunas áreas comunes",
    checked: false,
  },
  {
    name: "Oficina",
    description:
      "🏨 Disfruta de una oficina privada",
    checked: false,
  },
  {
    name: "Mansion ",
    description: "🏰 Hospédate en un espacio compartido, como una sala común",
    checked: false,
  },
  {
    name: "Mansion2 ",
