...
const PriceRangeInput: FC<PriceRangeInputProps> = ({
  ...
  const formatValue = (value: number): string => {
    if (value >= 1000000) {
      return `${convertNumbThousand(value / 1000000)}M`;
    } else {
      return `${convertNumbThousand(value / 1000)}k`;
    }
  };
            ...
            >
              ...
              <div className="flex-grow">
                <span className="block xl:text-lg font-semibold truncate">
                  {`$${formatValue(rangePrices[0])} ~ $${formatValue(rangePrices[1])}`}
                </span>
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md">
                      ...
                      <input
                        ...
                        value={formatValue(rangePrices[0])}
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md">
                      ...
                      <input
                        ...
                        value={formatValue(rangePrices[1])}
                      />
                    </div>
                  </div>
                </div>
